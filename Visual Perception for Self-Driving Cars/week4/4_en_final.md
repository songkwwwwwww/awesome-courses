Hello, and welcome to the last lesson of the Object Detection Module
...
이 예에서, 첫 번째 단계는 각 상자가 속한 클래스를 지정하지 않고 이미지의 모든 트래픽 기호와 신호를 가리키는 클래스 불가지론적 경계 상자를 출력합니다
